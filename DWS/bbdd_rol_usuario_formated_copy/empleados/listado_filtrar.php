...
<body>
  ...
  if (
    isset($_POST['texto']) || isset($_POST['salarioMinimo'])
    || isset($_POST['salarioMaximo'])  || isset($_POST['hijos'])
  ) { //si alguna de las variables de $_post existe
  ...
  <div class="contenedor">
    <div class="enlaces">
      <a href="../acceso/index.php">Volver a página de listados</a>
    </div>
  </div>
