                    ...
                    <form action="<?php echo (htmlspecialchars($_SERVER['PHP_SELF'])) ?>" method="post">
                        <div class="grid gap-y-4">
                            <div>
                                <label
                                    for="nombre"
                                    class="block text-sm font-bold ml-1 mb-2 dark:text-white">Nombre del empleado
                                </label>
                                <div class="relative">
                                    <input
                                        type="nombre"
                                        ...
                                        placeholder="<?php echo ($nombre != "" ? $nombre : "Nombre del empleado") ?>" />
                                </div>
                            </div>
                            <div class="text-center">
                                <?php
                            ...
                            <div>
                                <label
                                    for="email"
                                    class="block text-sm font-bold ml-1 mb-2 dark:text-white">Email del empleado
                                </label>
                                <div class="relative">
                                    <input
                                        type="text"
                            ...
                            <div>
                                <label
                                    for="perfil"
                                    class="block text-sm font-bold ml-1 mb-2 dark:text-white">Perfil del empleado</label>
                                <div class="relative">
                                    <select
                                        id="perfil"
                                        name="perfil"
                            ...
                            <div>
                                <label
                                    for="contrasenna"
                                    class="block text-sm font-bold ml-1 mb-2 dark:text-white">Contraseña del empleado
                                </label>
                                <div class="relative">
                                    <input
                                        type="contrasenna"
