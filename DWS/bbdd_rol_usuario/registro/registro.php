<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        if (count($errores) === 0) {
           ...
           http://localhost:3000/DWS/bbdd_rol_usuario/registro/verificar-cuenta.php?email=$emailEncode&token=$tokenEncode
                ";
            // Envio del email
...
<?php
    ...
    ?>
                <option value="<?php echo $registro['id']?>"><?php echo $registro["nombre"] . " : " . $registro['id']; ?></option>
    <?php
    endwhile;
    ?>
