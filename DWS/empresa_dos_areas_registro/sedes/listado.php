...
<body>
    ...
    <table border="1" cellpadding="10">
        ...
        <?php
                foreach($rdo as $row){
                    echo "<tr><td>". $row['nombre']. "</td><td>". $row['direccion']. 
                    "</td><td><a href='modificar.php?idSede=$row[id]' class='estilo_enlace'>&#9998</a>
                    <a href='borrar.php?idSede=$row[id]' class='confirmacion_borrar'>&#128465</a></td></tr>".PHP_EOL;
                }
    ...
    <div class="contenedor">
        ...
        <p><a href="../index.php">Volver a página de listados</a>
             ...
             &nbsp;&nbsp;&nbsp;&nbsp;<a href="nuevo.php">Crear nueva sede</a></p>
        </div>
    </div>
    ...
    <!--<script type="text/javascript">
                var elementos = document.querySelector('.confimracion_borrar')
                if(!confirm())
                </script>-->
</body>
</html>